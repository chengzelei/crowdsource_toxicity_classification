...
class CustomTrainer(PartialLabelTrainer):
    def __init__(
        self,
    ...
    def create_weight_optimizer(self):
        ...
        if self.weight_optimizer is None:
            ...
            optimizer_cls, optimizer_kwargs = CustomTrainer.get_optimizer_cls_and_kwargs(self.args)
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    if step % 1 == 0:
                        ...
                        #     # pg_loss = (- worker_log_probs[i*100:(i+1)*100]* 100* metrics['valid_batch_accuracy'][i] - 0.001 * entropy[i*100:(i+1)*100].sum()).mean()
